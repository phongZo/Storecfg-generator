...
// Type: StorecfgGenerator.ConditionProcessInputVisibility
...
{
  public class ConditionProcessInputVisibility : IValueConverter
  {
    public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
    {
      if (!(value is string str))
        return Binding.DoNothing;
      return str == "PROCESS" ? (object) Visibility.Visible : (object) Visibility.Collapsed;
    }
